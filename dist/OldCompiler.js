...
var Compiler = /** @class */ (function (_super) {
     ...
     * @param {{ rows: number, cols: number }} opts.dimensions - pseudo-tty dimensions
    ...
    Compiler.prototype.exec = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        runner = langList_1.default.compilers[this.opts.langNum];
                    ...
                    case 4:
                        ...
                        this.process = node_pty_1.spawn("docker", args, __assign({ name: 'xterm-256color' }, this.opts.dimensions));
